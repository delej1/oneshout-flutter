...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/nova_logo.png
  AssetGenImage get novaLogo =>
      const AssetGenImage('assets/images/nova_logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [googleLogo, novaLogo];
}
