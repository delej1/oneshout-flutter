// ignore_for_file: lines_longer_than_80_chars, overridden_fields
...
@injectable
class ThemeService extends ThemeServiceImpl {
  @override
  ...
  @override
  final ThemeData light = _lightThemeData;
  @override
  final ThemeData dark = _darkThemeData;
...
class ThemeBloc extends Bloc<ThemeEvent, ThemeState> {
  ThemeBloc() : super(ThemeState(themeData: MyAppTheme.light)) {
...
ThemeData _lightThemeData = _baseThemeData.copyWith(
  ...
  //   trackColor: MaterialStateProperty.all(_lightColorScheme.secondary),
  //   thumbColor: MaterialStateProperty.all(_lightColorScheme.onSecondary),
  // ),
  scaffoldBackgroundColor: Colors.white, // _lightColorScheme.primary,
  ...
  dividerTheme: _dividerTheme.copyWith(color: Colors.black12.withOpacity(0.1)),
...
ThemeData _darkThemeData = _baseThemeData.copyWith(
  ...
  // switchTheme: SwitchThemeData(
  //   trackColor: MaterialStateProperty.all(_darkColorScheme.secondary),
  //   // thumbColor: MaterialStateProperty.all(_darkColorScheme.onSecondary),
  // ),
  scaffoldBackgroundColor: _darkColorScheme.background,
  canvasColor: _darkColorScheme.background,
  dialogBackgroundColor: _darkColorScheme.background,
  bottomSheetTheme:
      BottomSheetThemeData(backgroundColor: _darkColorScheme.secondary),
  appBarTheme: _baseAppBarTheme.copyWith(
    systemOverlayStyle: SystemUiOverlayStyle(
      statusBarColor: Colors.transparent,
      statusBarBrightness:
  ...
  dividerTheme: _dividerTheme.copyWith(color: Colors.white10),
