...
abstract class AppLocales {
  ...
  static const fr = LangVo("Français", "French", "fr", Locale("fr"), "🇫🇷");
  static const available = <LangVo>[en,es,fr];
  static List<Locale> get supportedLocales => [en.locale,es.locale,fr.locale];
