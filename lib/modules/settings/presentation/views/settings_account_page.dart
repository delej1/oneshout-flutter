...
class _AccountPageState extends State<AccountPage> {
  ...
  Widget buildPrivacy(BuildContext context) => SimpleSettingsTile(
        ...
        onTap: () {
          launchUrl(
            Uri.parse(
              'https://sites.google.com/view/one-shout/privacy-policy',
            ),
          );
        },
      );
  ...
  //.....................................................................................
  Widget buildEula(BuildContext context) => SimpleSettingsTile(
    title: 'Terms of Use',
    subtitle: '',
    leading: const IconWidget(icon: Icons.rule, color: Colors.blue),
    onTap: () {
      launchUrl(
        Uri.parse(
