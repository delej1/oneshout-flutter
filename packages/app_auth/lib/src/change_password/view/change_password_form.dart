...
Widget _stepOne(BuildContext context) {
  const isGroupTarget = bool.fromEnvironment('IS_GROUP_TARGET');
  return Align(
        ...
        Column(
          children: [
            ...
            ...[
              ...
              VSpace.xl,
              const Text(
                "Want to change your password? Please enter the phone number associated with your account.",
    ...
    return BlocBuilder<ChangePasswordCubit, ChangePasswordState>(
      ...
      builder: (context, state) {
        return IntlPhoneField(
          ...
          onChanged: (phone) =>
              context.read<ChangePasswordCubit>().phoneChanged(phone),
          controller: context.read<ChangePasswordCubit>().phoneTC,
